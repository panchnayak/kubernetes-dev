## This is how you install Jenkins on your Kubernetes Cluster

```

$ kubectl apply -f jenkins-namespace.yaml
$ kubectl apply -f jenkins-vol.yaml
$ kubectl apply -f jenkins-vol-claim.yaml
...
![image](https://user-images.githubusercontent.com/31803506/120934869-1b637e80-c6ce-11eb-8fb0-18ea3a17f3c0.png)
